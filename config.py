...
class ScriptArguments:
    ...
    max_eval_size: Optional[int] = field(default=300, metadata={"help": "the maximum size of the evaluation dataset"})
    max_data_per_client: Optional[int] = field(default=600, metadata={"help": "the maximum number of data samples per client. -1 means use all the data available"})
...
if script_args.use_peft:
    if fed_args.fed_alg == "feddpa":
        peft_config = peft_feddpa.LoraConfig(
